...
rmoney=tk.Entry(Carlist,font=("times 16 "),width=13,textvariable=Rmoney).place(x=105,y=160,anchor="w")
...
tk.Button(Carlist,text="เอาเข้าdata",font=("times 10 "),command=databest).place(x=450,y=240,anchor="w")
